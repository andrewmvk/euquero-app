...
import ServicesGlossary from "../screens/ServicesGlossary";
...
export default () => (
  <Stack.Navigator
    initialRouteName="UBSScorecards"
    screenOptions={{
      headerShown: false,
  ...
  >
    ...
    <Stack.Screen
      name="NumberSelectionModal"
      component={NumberSelectionModal}
    />
    <Stack.Screen name="ServicesGlossary" component={ServicesGlossary} />
